          ...
          return Wrap(
            ...
            children: [
              ...
              _buildStatCard('Commission',
                  ...
                  width: hw),
              _buildStatCard('Net Income',
                  'Rs. ${s.netIncome.toStringAsFixed(0)}',
                  'Online income - commission',
                  Icons.trending_up,
